<?php /* Smarty version Smarty-3.1.16, created on 2016-02-10 20:52:41
         compiled from "C:\Program Files (x86)\Ampps\www\booked\tpl\Admin\manage_users.tpl" */ ?>
<?php /*%%SmartyHeaderCode:451456bb95091bd040-57743424%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bd8cfa4a4ed386e22f10520a9d14dd765102d777' => 
    array (
      0 => 'C:\\Program Files (x86)\\Ampps\\www\\booked\\tpl\\Admin\\manage_users.tpl',
      1 => 1450328288,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '451456bb95091bd040-57743424',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_56bb95093d99a0_15285402',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56bb95093d99a0_15285402')) {function content_56bb95093d99a0_15285402($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_options')) include 'C:\\Program Files (x86)\\Ampps\\www\\booked\\lib\\Common/../../lib/external/Smarty/plugins\\function.html_options.php';
if (!is_callable('smarty_function_cycle')) include 'C:\\Program Files (x86)\\Ampps\\www\\booked\\lib\\Common/../../lib/external/Smarty/plugins\\function.cycle.php';
?>
...
<h1><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'ManageUsers'),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>"question-button.png",'id'=>"help-prompt",'ref'=>"help-users"),$_smarty_tpl);?>
</h1>
...
">&nbsp;</div>
		...
		<?php if (count($_smarty_tpl->tpl_vars['attributes']->value)>0) {?>
			<tr>
				<td class="id"><input type="hidden" class="id" value="<?php echo $_smarty_tpl->tpl_vars['id']->value;?>
"/></td>
				<td colspan="17" class="<?php echo $_smarty_tpl->tpl_vars['rowCss']->value;?>
...
?>
									<?php $_smarty_tpl->tpl_vars["attributeValue"] = new Smarty_variable($_smarty_tpl->tpl_vars['user']->value->GetAttributeValue($_smarty_tpl->tpl_vars['attribute']->value->Id()), null, 0);?>
									<li class="customAttribute" attributeId="<?php echo $_smarty_tpl->tpl_vars['attribute']->value->Id();?>
">
										<div class="attribute-readonly"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['control'][0][0]->DisplayControl(array('type'=>"AttributeControl",'attribute'=>$_smarty_tpl->tpl_vars['attribute']->value,'value'=>$_smarty_tpl->tpl_vars['attributeValue']->value,'readonly'=>true),$_smarty_tpl);?>
</div>
										<div class="attribute-readwrite hidden"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['control'][0][0]->DisplayControl(array('type'=>"AttributeControl",'attribute'=>$_smarty_tpl->tpl_vars['attribute']->value,'value'=>$_smarty_tpl->tpl_vars['attributeValue']->value),$_smarty_tpl);?>
...
<div class="admin" style="margin-top:30px">
	<div class="title">
		<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Import'),$_smarty_tpl);?>
	...
	<div>
		<div class="validationSummary">
			<ul>
				...
				<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['async_validator'][0][0]->AsyncValidator(array('id'=>"importUsersValidator",'key'=>''),$_smarty_tpl);?>
...
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Done'),$_smarty_tpl);?>
		...
		<form id="importUsersForm" method="post" enctype="multipart/form-data" ajaxAction="<?php echo ManageUsersActions::ImportUsers;?>
">
 ...
 />
			...
			<div class="admin-update-buttons">
				<button type="button" class="button save"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['html_image'][0][0]->PrintImage(array('src'=>"table-import.png"),$_smarty_tpl);?>
 <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'Import'),$_smarty_tpl);?>
</button>
			</div>
		</form>
	...
	<div>
		<span class="note"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'UserImportInstructions'),$_smarty_tpl);?>
</span>
		<a href="<?php echo $_SERVER['SCRIPT_NAME'];?>
?dr=template" target="_blank"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0][0]->SmartyTranslate(array('key'=>'GetTemplate'),$_smarty_tpl);?>
</a>
	</div>
</div>
